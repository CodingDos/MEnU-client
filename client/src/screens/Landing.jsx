            ...
            {formToggle ? (
              <div className="form-container">
                <div className="intro-container">
                  ...
                  <p className="intro-paragraph"> In a world where culinary creativity knows no bounds and the joy of 
                    sharing delicious discoveries is limitless, welcome to MEnU! 
                    Embark on a journey where flavors converge, cultures intertwine, and recipes
                    come to life in vibrant detail. Whether you're a seasoned chef or a kitchen 
                    novice, our platform offers a dynamic space where you can explore, share, 
                    and savor an endless array of culinary delights. </p>
                  <p className="intro-paragraph join" >Join our community today and let the aroma of creativity waft through your feed</p>
                  <button className="toggletag have-account" onClick={handleRegisterLoginClick}>
                    Have An Accout
                  </button>
                </div>
